<template>
 ...
 <section class="vh-100 gradient-custom">
  <div class="container py-5 h-100">
        ...
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form @submit.prevent="handleSubmit">
              <div class="error" v-if="emptyError" style="color:red;">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                   <label class="form-label" for="emailAddress">Email</label>
                    <input type="email" id="emailAddress" class="form-control form-control-lg" v-model="email"/>
                    <div style="color:red" v-if="usedMail">
              This is a used email.
            </div>
                    <div style="color:red" v-else-if="invalidEmail">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="femaleGender"
                      value="F" checked  v-model="Gender"/>
                    <label class="form-check-label" for="femaleGender">Female</label>
                  </div>

                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="maleGender"
                      value="M" v-model="Gender"/>
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                   <label class="form-label" for="Password">Password</label>
                    ...
                    <div style="color:red" v-if="lengthError">
              The password should be minimum 8 characters length
            </div>
            <div style="color:red" v-else-if="lowerCase">
              Password should contain a lower case letter
            </div>
            <div style="color:red" v-else-if="upperCase">
              Password should contain an upper case letter
            </div>
            <div style="color:red" v-else-if="number">
    ...
    <select class="form-control form-control-lg" name="nationality" v-model="nationality">
...
<br>
                ...
                <div class=" mb-4">
                  ...
                  <div class="form-outline">
                    ...
                    <select class="form-control form-control-lg" name="userRole" v-model="userRole">
        <option value="Manager">Manager</option>
        <option value="Fan">Fan</option>
        </select>
                    
                    <!-- <input type="text" id="userRole" class="form-control form-control-lg" v-model="userRole"/> -->
    ...
    <p>Iam a member? <router-link to="/login">SIGN IN </router-link ></p>
...
methods:{
  ...
  resetflags() {
    ...
    this.number = false;
    this.usedMail=false;
    this.cleanPassword=false;
  },
  handleSubmit: function () {
    var mailformat = /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/;  
    if (!this.email || !this.password || !this.username || !this.lastname || !this.firstname || !this.nationality || !this.Birthday) {
      this.resetflags();
